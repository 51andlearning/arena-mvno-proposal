...
export default function ExecutiveSummary() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="absolute inset-0 opacity-[0.22] [background-image:radial-gradient(circle_at_15%_85%,#B91C1C_0,transparent_40%),radial-gradient(circle_at_85%_95%,#F59E0B_0,transparent_40%)]"
      />

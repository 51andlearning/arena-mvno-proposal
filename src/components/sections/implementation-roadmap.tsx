      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="mt-14 space-y-4">
          {implementationRoadmap.phases.map((p, i) => (
            <div
              key={p.phase}
              className="relative grid gap-4 rounded-2xl border border-slate-200 bg-white p-6 transition hover:border-[#B91C1C]/20 hover:shadow-[0_14px_40px_-20px_rgba(185,28,28,0.2)] md:grid-cols-[auto_auto_1fr] md:items-start md:gap-8 md:p-7"
            >
              {/* Phase number */}
              <div className="flex items-center gap-4 md:w-48">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#B91C1C] text-lg font-bold text-white">
                  {i + 1}
                </div>
                <div>

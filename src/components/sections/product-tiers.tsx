          ...
          {productTiers.tiers.map((tier) => (
            ...
            >
              ...
              <div
                className={
                  tier.highlight
                    ? "mt-3 inline-flex rounded-full bg-[#F59E0B]/15 px-2.5 py-0.5 text-[11px] font-semibold text-[#F59E0B]"
                    : "mt-3 inline-flex rounded-full bg-emerald-50 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-700"
                }
              >
                {tier.margin}
              </div>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {contentBundles.bundles.map((b) => (
            ...
            >
              ...
              <div className="mt-5 inline-flex items-center gap-1.5 rounded-full bg-[#0F172A] px-3 py-1 text-xs font-medium text-white">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"

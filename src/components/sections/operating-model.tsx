      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10">
              ...
              <div
                className={
                  i === 1
                    ...
                    : "mb-4 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-[#B91C1C]/10 text-[#B91C1C]"
                }
              >
                {ICON_MAP[role.icon]}
              </div>
              ...
              <p
                className={
                  i === 1
                    ...
                    : "mt-1 text-sm font-medium text-[#B91C1C]"
                }
              >
                {role.scope}
              </p>
                    ...
                    <span
                      className={
                        i === 1
                          ...
                          : "mt-1.5 h-1 w-1 shrink-0 rounded-full bg-[#B91C1C]"
                      }
                    />
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {trackRecord.stats.map((s) => (
            ...
            >
              <div className="text-3xl font-semibold tracking-tight text-[#B91C1C] md:text-4xl">
                {s.value}
              </div>
        ...
        <div className="mt-16">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {trackRecord.mvnoLaunches.map((m) => (
              <div
                key={m.name}
                className="rounded-2xl border border-slate-200 bg-white p-6 transition hover:border-[#B91C1C]/30 hover:shadow-[0_14px_40px_-20px_rgba(185,28,28,0.25)]"
              >
                <h4 className="text-lg font-semibold tracking-tight text-[#0F172A]">
                  {m.name}
                </h4>
                <p className="mt-1 text-xs font-medium text-[#B91C1C]">{m.type}</p>

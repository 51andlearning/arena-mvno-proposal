import { platformCapabilities, commercialModel } from "@/content/proposal";
              ...
              >
                ...
                <div>
                  <span
                    className={
                      c.who === "Arena"
                        ? "inline-flex rounded-full bg-[#B91C1C]/10 px-2.5 py-0.5 text-xs font-semibold text-[#B91C1C]"
